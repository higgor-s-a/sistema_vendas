...
DADOS_MOCK = {
    "usuarios": [
        {"id": 1, "usuario": "admin", "senha_hash": "$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LezfxYzHvLz5py2W", "nivel": "admin", "ativo": "TRUE"},  # senha: demo123
        {"id": 2, "usuario": "vendedor", "senha_hash": "$2b$12$dummy.hash.for.demo", "nivel": "user", "ativo": "TRUE"}
    ],
    "clientes": [
    ...
    "produtos": [
        {"id": 1, "nome": "Produto A", "preco": 100.00, "estoque": 50, "ativo": "TRUE"},
        {"id": 2, "nome": "Produto B", "preco": 200.00, "estoque": 30, "ativo": "TRUE"}
    ],
    "vendas": [
        {"id": 1, "cliente_id": 1, "produto_id": 1, "quantidade": 2, "total": 200.00, "data": "2024-01-15", "status": "concluida"}
    ],
    "pagamentos": [
        {"id": 1, "venda_id": 1, "valor": 200.00, "data": "2024-01-15", "metodo": "dinheiro"}
    ],
    "logs": []
}
...
def conectar_sheet():
    ...
    if not creds_json or demo_mode:
    ...
    for tentativa in range(3):
        try:
            ...
            print(f"Erro ao conectar ao Google Sheets (tentativa {tentativa+1}): {str(e)}")
            time.sleep(1)
...
class MockWorksheet:
    ...
    def delete_rows(self, start_row, end_row=None):
        print(f"🗑️ Mock: Removendo linhas {start_row}-{end_row or start_row} de {self.nome}")
        return True
